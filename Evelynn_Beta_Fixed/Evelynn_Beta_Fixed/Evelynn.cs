	...
	class Evelynn
	{
		...
		private static void OnDraw(EventArgs args)
		{
			if (Config.IsChecked(MenuBuilder.MenuNames.Drawing, "draw.Q.range"))
			{
				...
				circle.Draw(Q.IsReady() ? System.Drawing.Color.Green : System.Drawing.Color.Brown);
			}	
			...
			if (Config.IsChecked(MenuBuilder.MenuNames.Drawing, "draw.Q.prediction"))
			{
				...
				if (target != null)
				{
					...
					rect.Draw(Q.IsReady() ? System.Drawing.Color.Blue : System.Drawing.Color.Brown);
				}
			}
		}
