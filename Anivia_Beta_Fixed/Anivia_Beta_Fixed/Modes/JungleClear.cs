...
using Settings = Anivia_Beta_Fixed.Config.Modes.JungleClear;

namespace Anivia_Beta_Fixed.Modes
{
    public sealed class JungleClear : ModeBase
    {
        ...
        {
            if (Anivia_Beta_Fixed.Config.Modes.Combo.deactiveR && Player.Instance.Spellbook.GetSpell(SpellSlot.R).ToggleState == 2)
            {
