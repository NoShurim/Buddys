...
using Settings = Ashe_Beta_Fixed.MenusSetting.Modes.Combo;
    ...
    public sealed class Combo : ModeBase
    {
        ...
        public override void Execute()
        {
            ...
            if (Settings.UseW && W.IsReady())
            {
                ...
                if (target != null && target.Health > 0 && !target.IsInvulnerable && target.IsValidTarget() && W.GetPrediction(target).HitChance >= HitChance.Medium)
                {
