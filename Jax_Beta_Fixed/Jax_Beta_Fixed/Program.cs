...
namespace Jax_Beta_Fixed
{
    class Program
    {
        ...
        //Menus Target vBool Etc
        static Spell.Targeted Smite = null;
        //Menu
        public static Menu jureg, FarmingMenu, MiscMenu, DrawMenu, HarassMenu, ComboMenu, SmiteMenu;
        //Header Menu
        ...
        private static void Loading_OnComplete(EventArgs args)
        {
            ...
            jureg = MainMenu.AddMenu("Jax", "Jax");

            ComboMenu = jureg.AddSubMenu("Combo");
            ...
            HarassMenu = jureg.AddSubMenu("Harass");
            ...
            FarmingMenu = jureg.AddSubMenu("LaneClear");
            ...
            {
                SmiteMenu = jureg.AddSubMenu("Smite Usage");
            ...
            MiscMenu = jureg.AddSubMenu("Misc");
            ...
            DrawMenu = jureg.AddSubMenu("Draw Settings", "Drawings");
