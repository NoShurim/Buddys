...
using Jax_Beta_Fixed.Bases.Interface;
using Jax_Beta_Fixed.Managers;
...
namespace Jax_Beta_Fixed.Bases
{
    abstract class HeroBase : IHero
    {
        ...
        public static string HERO_MENU { get { return "NoShu" + EloBuddy.Player.Instance.ChampionName; } }
        protected Menu flee;
        protected Menu misc;
        protected Menu draw;
