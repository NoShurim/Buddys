...
{
    public static class MenusSettings
    {
        private const string MenuName = "Nunu";

        public static readonly Menu Menu;

        static MenusSettings()
        {
        ...
        public static class Modes
        {
            ...
            static Modes()
            {
                ...
                Menu = MenusSettings.Menu.AddSubMenu("Modes");
        ...
        public static class Smite
        {
            ...
            static Smite()
            {
                ...
                SMenu = MenusSettings.Menu.AddSubMenu("Smite Menu");
        ...
        public static class Draw
        {
            ...
            static Draw()
            {
                ...
                DMenu = MenusSettings.Menu.AddSubMenu("Draw Menu");
